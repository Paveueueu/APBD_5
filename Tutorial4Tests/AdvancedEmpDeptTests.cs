...
public class AdvancedEmpDeptTests
{
    ...
    public void ShouldFindAnyWithCommissionOver400()
    {
        ...
        var result = emps.Any(emp => emp.Comm is > 400);
    ...
    public void ShouldJoinEmpDeptSalgrade()
    {
        ...
        var result = emps.Join(
            ...
            .Where(grade => empDept.Sal >= grade.Losal && empDept.Sal <= grade.Hisal)
            .Select(grade => new { empDept.EName, empDept.DName, grade.Grade })
        );
